...
namespace AssAPP.Controllers
{
    public class NhanViensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaNhanVien,TenNhanVien,NgaySinh,Address,SoDienThoai,Email")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaNhanVien,TenNhanVien,NgaySinh,Address,SoDienThoai,Email")] NhanVien nhanVien)
        {
