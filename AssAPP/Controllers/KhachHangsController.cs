...
namespace AssAPP.Controllers
{
    public class KhachHangsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdKhachHang,Name,Phone,Address,BirthDay,NgayDangKi")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKhachHang,Name,Phone,Address,BirthDay,NgayDangKi")] KhachHang khachHang)
        {
